...
# {}는 3세기 중엽 고이왕 때 {}을 병합하여 한강 유역 대부분을 차지하였으며, 관등제를 정비하고 관리의 복색을 정하는 등 중앙 집권적 지배 체제의토대를 마련하였다.
...
def multiple_question(choice_list, count, quesiton_id):
  keys = ["questionId", "choice", "state"]
  result = []
...
print(multiple_question(choice_list, 3, 1000))
